...
# Works WITHOUT redirect URI configuration!
# No browser popup needed - just enter code
# ========================================

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "  Microsoft OAuth API Key Generator" -ForegroundColor Cyan
Write-Host "  Device Code Flow (No redirect URI needed)" -ForegroundColor Cyan
...
try {
    # Step 1: Authenticate with Microsoft using Device Code Flow
    Write-Host "Step 1: Authenticating with Microsoft (Device Code Flow)..." -ForegroundColor Yellow
    Write-Host "`nYou'll receive a code to enter at Microsoft login page." -ForegroundColor Cyan
    Write-Host "This method doesn't require redirect URI configuration!`n" -ForegroundColor Cyan
    ...
    Write-Host "`n✓ Microsoft authentication successful!" -ForegroundColor Green
...
"@ | Out-File -FilePath $fileName -Encoding UTF8
    ...
    Write-Host "3. Make sure device code flow is allowed in Azure App Registration" -ForegroundColor White
